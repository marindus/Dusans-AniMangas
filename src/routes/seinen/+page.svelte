...
<header class="header">
  <div class="left">
    <a href="/seinen/create" class="add-button">Add AniManga</a>
  </div>
  ...
  <div class="right">
    <span>Welcome Musashi</span>
    <img src="/images/musashi_pb.png" alt="Musashi" class="profile-pic" />
  </div>
</header>

<div class="center-box seinen">
  <table class="list-table">
    ...
    <tbody>
      {#each ranked as animanga, i}
        <AnimangaCard animanga={animanga} rank={i + 1} genre="seinen"/>
      {/each}
    </tbody>
  </table>
</div>
