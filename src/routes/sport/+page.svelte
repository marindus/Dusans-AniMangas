...
<header class="header">
  <div class="left">
    <a href="/sport/create" class="add-button">Add AniManga</a>
  </div>
  ...
  <div class="right">
    <span>Welcome Kagami</span>
    <img src="/images/kagami_pb.png" alt="Kagami" class="profile-pic" />
  </div>
</header>

<div class="center-box sport">
  <table class="list-table">
    ...
    <tbody>
      {#each ranked as animanga, i}
        <AnimangaCard animanga={animanga} rank={i + 1} genre="sport" />
      {/each}
    </tbody>
  </table>
</div>
