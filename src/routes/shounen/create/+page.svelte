...
<div class="header-links">
    <a href="/shounen" class="back-link">← Back to Shounen</a>
    <h1 class="main-title">Add new Shounen AniManga</h1>
</div>
...
<div class="form-center-box">
    <form method="POST" action="?/create" class="form-content">
        ...
        <input type="hidden" name="genre" value="Shounen" />
        <button type="submit" class="submit-btn">Add AniManga</button>
    </form>

    <!-- gets success message from +page.server.js -->
    {#if form?.success}
